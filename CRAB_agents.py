...
class Firm(CRAB_Agent):
    ...
    def capital_investment(self, inv_frac: float=0.1) -> int:
        ...
        if self.feasible_production < desired_prod:
            ...
            n_expansion = 0
        self.n_expansion = n_expansion  # TODO: REMOVE!
        return n_expansion
    ...
    def replace_capital(self) -> int:
        ...
        # Bound number of replacements by percentage of current capital amount
        capital_amount = sum(vin.amount for vin in self.capital_vintage)
        n_replacements = round(min(n_replacements, 0.2 * capital_amount))

        self.n_replacements = n_replacements  # TODO: remove
    ...
    def get_avg_prod(self) -> float:
        ...
        Q = 0
        machines_used = []
        # # TODO: changed, check if can stay!
...
class CapitalFirm(Firm):
    ...
    def stage1(self) -> None:
        ...
        self.update_price(markup=0.4)  # TODO: CHECK, remove?
        self.advertise()
